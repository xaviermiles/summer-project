"""
Aim to use deeplab (v1,v2,v3 or v3+) to perform semantic segmentation on the rural dataset
"""
...
# Set up model
MODEL_NAME = 'mobilenetv2_coco-voctrainaug'
...
# Run on sample image
image_filename = 'osm11_res10m__167.34_-45.58__167.52_-45.46.jpeg'

run_visualization(MODEL, image_filename)
